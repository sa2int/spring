			...
			<div class="jumbotron" style="padding-top: 20px;">
				...
				<form method="post" action="signUpInput">
					...
					<div class="form-group">
						...
						<input type="submit" id="submit" class="form-control submit btn btn-primary" value="submit"
							 maxlength="20">
						<input type="reset" class="form-control submit btn btn-primary" value="reset"
							 maxlength="20">	 
